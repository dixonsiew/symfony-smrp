...
const COLUMN_MAP = [
    ...
    new ColumnMap("DISCHARGE_DATE", "DISCHARGE DATE"),
    new ColumnMap("DISCHARGE_TIME", "DISCHARGE TIME"),

    new ColumnMap("DISCHARGE_REASON", "DISCHARGE REASON"),
    new ColumnMap("DIAGNOSIS_DESC", "DIAGNOSIS DESC"),
    new ColumnMap("ICD10_CODE", "ICD CODE"),
    new ColumnMap("ICD10_DESCRIPTION", "ICD DESC"),
];