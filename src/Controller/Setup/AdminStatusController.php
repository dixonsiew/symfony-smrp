...
class AdminStatusController extends AbstractController
{
    ...
    #[Route('/api/adm-statuses', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
    ...
    #[Route('/api/adm-statuses', methods: ['POST'])]
    ...
    #[Route('/api/adm-status', methods: ['POST'])]
    ...
    #[Route('/api/adm-status/{id}', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/adm-status/{id}', methods: ['PUT'])]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: '#/components/schemas/CommonSetupDto'))]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/adm-status/{id}', methods: ['DELETE'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
