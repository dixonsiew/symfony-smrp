...
class WardClassController extends AbstractController
{
    ...
    #[Route('/lookup/ward-classes', methods: ['GET'])]
    ...
    #[Route('/ward-classes', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
    ...
    #[Route('/ward-classes', methods: ['POST'])]
    ...
    #[Route('/ward-class/{id}', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/ward-class/{id}', methods: ['PUT'])]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: '#/components/schemas/CommonSetupDto'))]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/ward-class/{id}', methods: ['DELETE'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
