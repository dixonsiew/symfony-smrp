...
class AdminStatusController extends AbstractController
{
    ...
    private const table = 'adm_status';
    ...
    #[Route('/lookup/adm-statuses', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[OA\Response(
        response: 200,
    ...
    #[Route('/adm-statuses', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
    ...
    #[Route('/adm-statuses', methods: ['POST'])]
    ...
    #[Route('/adm-status/{id}', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/adm-status/{id}', methods: ['PUT'])]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: '#/components/schemas/CommonSetupDto'))]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/adm-status/{id}', methods: ['DELETE'])]
    #[OA\Tag(name: 'Setup/AdmStatus')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
