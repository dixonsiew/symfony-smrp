...
class WardClassController extends AbstractController
{
    ...
    private const table = 'ward_class';
    ...
    #[Route('/api/lookup/ward-classes', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[OA\Response(
        response: 200,
    ...
    #[Route('/api/ward-classes', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
    ...
    #[Route('/api/ward-classes', methods: ['POST'])]
    ...
    #[Route('/api/ward-class', methods: ['POST'])]
    ...
    #[Route('/api/ward-class/{id}', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/ward-class/{id}', methods: ['PUT'])]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: '#/components/schemas/CommonSetupDto'))]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/ward-class/{id}', methods: ['DELETE'])]
    #[OA\Tag(name: 'Setup/WardClass')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
