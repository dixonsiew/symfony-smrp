...
class ReferralController extends AbstractController
{
    ...
    #[Route('/api/lookup/referrals', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/Referral')]
    #[OA\Response(
        response: 200,
    ...
    #[Route('/api/referrals', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/Referral')]
    #[OA\Response(
        response: 200,
        description: 'Successful response',
    ...
    #[Route('/api/referrals', methods: ['POST'])]
    ...
    #[Route('/api/referral', methods: ['POST'])]
    ...
    #[Route('/api/referral/{id}', methods: ['GET'])]
    #[OA\Tag(name: 'Setup/Referral')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/referral/{id}', methods: ['PUT'])]
    #[OA\RequestBody(required: true, content: new OA\JsonContent(ref: '#/components/schemas/CommonSetupDto'))]
    #[OA\Tag(name: 'Setup/Referral')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
    ...
    #[Route('/api/referral/{id}', methods: ['DELETE'])]
    #[OA\Tag(name: 'Setup/Referral')]
    #[Security(name: 'Bearer')]
    #[IsGranted('IS_AUTHENTICATED_FULLY')]
